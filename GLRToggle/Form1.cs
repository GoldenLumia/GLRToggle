...
namespace GLRToggle
{
    public partial class Form1 : Form
    {
        public void FileCheck()
        {
            ...
            string path3 = @"C:\Program Files (x86)\Steam\appcache\appinfo.vdf";
            string path4 = @"C:\Program Files (x86)\Steam\version.dll";
            string path5 = @"C:\Program Files (x86)\Steam\disabled\version.dll";
        ...
        {
            string path = @"C:\Program Files (x86)\Steam\appcache\appinfo.vdf";
            string path2 = @"C:\Program Files (x86)\Steam\appcache\packageinfo.vdf";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string path = @"C:\Program Files (x86)\Steam\disabled\version.dll";
            string path2 = @"C:\Program Files (x86)\Steam\version.dll";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            string path = @"C:\Program Files (x86)\Steam\version.dll";
            string path2 = @"C:\Program Files (x86)\Steam\disabled\version.dll";
